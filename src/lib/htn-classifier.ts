...
export function getHTNSeverity(bp: BPReading): HTNSeverity {
  ...
  if (
    sbp >= BP_THRESHOLDS.PREHYPERTENSION.sbp ||
    dbp >= BP_THRESHOLDS.PREHYPERTENSION.dbp
  ) {
    return "prehypertension";
  }
  return "normal";
 ...
 */
export function getHTNRecommendations(
  classification: HTNType,
  bp: BPReading,
): string[] {
