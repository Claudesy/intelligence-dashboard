...
export function mapDashboardToTransferPayload(
  data: DashboardEncounterData,
): RMETransferPayload {
  ...
  const anamnesa: AnamnesaFillPayload = {
    ...
    vital_signs:
      tdParsed.sistolik > 0
        ? {
            ...
            gula_darah: data.gulaDarah
              ? parseNumber(data.gulaDarah.nilai) || undefined
              : undefined,
    ...
    periksa_fisik: {
      gcs_membuka_mata:
        gcsParsed.e as AnamnesaFillPayload["periksa_fisik"] extends {
          gcs_membuka_mata: infer T;
        }
          ? T
          : never,
      gcs_respon_verbal:
        gcsParsed.v as AnamnesaFillPayload["periksa_fisik"] extends {
          gcs_respon_verbal: infer T;
        }
          ? T
          : never,
      gcs_respon_motorik:
        gcsParsed.m as AnamnesaFillPayload["periksa_fisik"] extends {
