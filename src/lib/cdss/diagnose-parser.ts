...
export function parseDiagnoseRequestBody(
  body: unknown,
): DiagnoseRequestParseResult {
  ...
  return {
    ...
    input: {
      ...
      keluhan_tambahan:
        typeof b.keluhan_tambahan === "string"
          ? b.keluhan_tambahan.trim()
          : undefined,
      assessment_conclusion:
        typeof b.assessment_conclusion === "string"
          ? b.assessment_conclusion.trim()
          : undefined,
      usia,
      ...
      chronic_diseases: Array.isArray(b.chronic_diseases)
        ...
        : undefined,
      is_pregnant:
        typeof b.is_pregnant === "boolean" ? b.is_pregnant : undefined,
      current_drugs: Array.isArray(b.current_drugs)
        ? (b.current_drugs as string[])
        : undefined,
