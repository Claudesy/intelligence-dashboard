...
export default function VoicePage() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setVisiblePipeline((prev) =>
        prev >= PIPELINE_STEPS.length ? prev : prev + 1,
      );
    }, 180);
  ...
  const connect = useCallback(async () => {
    ...
    socket.on("voice:turn_complete", () => {
      ...
      setMessages((prev) => {
        const next = [...prev];
        if (userText)
          next.push({ id: Date.now(), role: "user", text: userText, time });
        if (assistantText)
          next.push({
            id: Date.now() + 1,
            role: "assistant",
      ...
      <div style={{ display: "flex", gap: 32, alignItems: "flex-start" }}>
        ...
        >
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Clinical AI real-time untuk konsultasi dokter — diferensial
                    diagnosis, dosis, tata laksana, dan kriteria rujukan dalam
                    konteks Puskesmas PONED Balowerti.
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    <strong style={{ color: "var(--text-main)" }}>Tahan</strong>{" "}
                    tombol mikrofon atau [SPACE] saat ingin bicara
                  </div>
                  <div>
                    <strong style={{ color: "var(--text-main)" }}>Lepas</strong>{" "}
                    saat selesai — Audrey akan merespons secara otomatis
                  </div>
                </div>
              </div>
            </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    — bagian dari ekosistem <strong>AADI</strong> Sentra
                    Healthcare Solutions. Mendampingi dokter secara real-time
                    selama encounter klinis.
                  </div>
                  <div
                    style={{
                      padding: "7px 12px",
          ...
          >
            ...
            Seluruh keputusan klinis tetap menjadi tanggung jawab penuh dokter
            yang bertugas.
            <span
              style={{
                display: "block",
          ...
          >
            ...
            >
              Fitur ini masih dalam tahap pengembangan aktif. Performa, akurasi,
              dan stabilitas dapat berubah sewaktu-waktu.
            </span>
          </div>
        </div>
        {/* end left column */}
            ...
            {PIPELINE_STEPS.map((step, i) => (
              <div
                ...
                style={{
                  ...
                  transform:
                    i < visiblePipeline ? "translateY(0)" : "translateY(8px)",
