...
export default function ClinicalTrajectoryChart({
  ...
  const alertKey = screeningAlerts
  ...
  const snapshotModel = useMemo(() => {
    ...
    const chronicPriorityCount = rpdItems.filter((item) =>
      HIGH_RISK_RPD.includes(item),
    ).length;
    const familyPriorityCount = familyItems.filter((item) =>
      HIGH_RISK_FAMILY_TOKENS.some((token) =>
    ...
    const historyRisk = clamp(
      18 + rpdItems.length * 8 + chronicPriorityCount * 10,
      0,
      100,
    );
    const familyRisk = clamp(
      10 + familyItems.length * 10 + familyPriorityCount * 8,
      0,
      100,
    );
  ...
  return (
    <div
      style={{
        ...
        boxShadow:
          "0 18px 40px rgba(0,0,0,0.16), inset 0 1px 0 rgba(255,255,255,0.02)",
      }}
    >
      {/* Header */}
      <div
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          <span
            style={{ fontSize: 13, color: CHART_TEXT_SOFT, lineHeight: 1.6 }}
          >
            {hasVisitHistory
              ...
              >
                <div
                  style={{
                    fontSize: 10,
                    color:
                      p.label === "HARI INI" ? "#FFCC8C" : CHART_TEXT_MUTED,
                ...
                <div style={{ fontSize: 10, color: CHART_TEXT_DIM }}>
                  HR {p.vitals.hr} · Suhu {p.vitals.temp} · GDS{" "}
                  {p.vitals.glucose || "-"}
                </div>
                {p.diagnosa && (
        ...
        <>
          ...
          >
            {[
              ...
              >
                ...
                <div
                  style={{ fontSize: 13, color: "#E5DDD4", lineHeight: 1.6 }}
                >
          ...
          >
            <div style={{ fontSize: 12, color: "#D2C6B8", lineHeight: 1.7 }}>
              Perhitungan ringkas:{" "}
              <span style={{ color: CHART_TEXT_SOFT }}>Historis</span> dibentuk
              dari bobot komorbid + riwayat keluarga, sedangkan{" "}
              <span style={{ color: CHART_TEXT_SOFT }}>Akut</span> dibentuk dari
              bobot alergi aktif + konteks hari ini. Visual ini membantu
              prioritas review klinis, bukan skor diagnosis baku.
            </div>
            <div
              style={{
                padding: "10px 12px",
            ...
            >
              ...
              <div style={{ fontSize: 12, color: CHART_TEXT_MUTED }}>
                Snapshot:{" "}
                <span style={{ color: "#FFCC8C" }}>
                  {snapshotModel.staticLoad}
                </span>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div style={{ fontSize: 12, color: CHART_TEXT_MUTED }}>
                Snapshot:{" "}
                <span style={{ color: "#FF8D81" }}>
                  {snapshotModel.acuteLoad}
                </span>
              </div>
            </div>
          </div>
