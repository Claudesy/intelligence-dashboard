            ...
            >
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: 13, color: L.muted, lineHeight: 1.5 }}>
                    Konektor antara sistem Rekam Medis Elektronik (RME) dengan Sentra Intelligence
                    Dashboard — bridge otomatis yang menghubungkan data klinis ke engine AI.
                  </div>
                </div>
                <a
              ...
              <div>
                <PanelSection L={L}>
                  ...
                  <div style={{ fontSize: 13, color: L.muted, lineHeight: 1.6 }}>
                    Ghost Protocol adalah bridge otomatis antara sistem RME (ePuskesmas) dengan
                    Sentra Intelligence Dashboard. Protokol ini memungkinkan transfer data
                    anamnesis, diagnosis, dan resep dari dashboard langsung ke formulir RME — tanpa
                    input ulang manual.
                  </div>
                </PanelSection>
                <PanelSection L={L}>
                  ...
                  <div style={{ fontSize: 13, color: L.muted, lineHeight: 1.6 }}>
                    Sentra Bridge Engine menghubungkan sesi RME aktif. Data CDSS (keluhan, diagnosis
                    ICD-10, terapi) di-transfer otomatis ke form ePuskesmas melalui socket bridge
                    dengan progress real-time. Session reuse 30 menit untuk efisiensi.
                  </div>
                </PanelSection>
