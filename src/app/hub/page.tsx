    ...
    children: [
      {
        ...
        subtitle:
          "Arah strategis, kebijakan eksekutif, dan arsitektur pengembangan teknologi",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        title:
          "Health Information Management (HIM) Specialist & Document Evaluator",
        subtitle:
          "Audit dokumen rekam medis dan tata kelola informasi kesehatan",
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        subtitle:
          "Keandalan, keamanan, dan pemeliharaan infrastruktur teknologi",
      },
    ],
  },
];
...
export default function HubPage() {
  ...
  const clinicalCount = roster.filter((member) =>
    ["Dokter", "Dokter Gigi", "Perawat", "Bidan", "Apoteker"].includes(
      member.profession,
    ),
  ).length;
  const summaryCards = [
    ...
    <div style={{ width: "100%", maxWidth: 1240 }}>
            ...
            {summaryCards.map((item) => (
              <div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, var(--bg-nav), var(--bg-card))",
                  padding: "16px 18px",
                  display: "grid",
                  gap: 8,
                }}
              ...
              >
                {roster.map((member, idx) => {
                  ...
                  const hasCredentials = !!(
                    member.profile?.strNumber || member.profile?.sipNumber
                  );
      ...
      {activeTab === "organisation" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          >
            ...
            >
              <div style={{ display: "grid", gap: 10 }}>
                ...
                >
                  Struktur organisasi Sentra yang lebih rapi, formal, dan mudah
                ...
                >
                  Organisasi dibingkai sebagai sistem kerja profesional:
                  eksekutif, audit klinis, operasi medis, dan relasi eksternal.
                  Setiap divisi ditampilkan sebagai unit tanggung jawab yang
                  jelas, bukan sekadar daftar nama.
                </div>
              </div>
            ...
            >
              <div style={{ display: "grid", gap: 6 }}>
                ...
                >
                  Peta struktur resmi untuk membaca jalur komando, ownership
                  divisi, dan keterkaitan antar fungsi.
                </div>
              </div>
              <div
          ...
          >
            Sentra Healthcare Solutions — Struktur Organisasi & Nomenklatur
            Profesional
          </div>
        </div>
      )}
