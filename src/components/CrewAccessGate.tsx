...
export default function CrewAccessGate({ children }: CrewAccessGateProps) {
  ...
  const [registerInstitution, setRegisterInstitution] =
    useState<CrewAccessInstitution>(CREW_ACCESS_INSTITUTIONS_SEED[0]);
  const [registerProfession, setRegisterProfession] =
    useState<CrewAccessProfession>(CREW_ACCESS_PROFESSIONS[0]);
  const [registerStep, setRegisterStep] = useState<1 | 2 | 3>(1);
  const [registerFullName, setRegisterFullName] = useState("");
  const [registerBirthPlace, setRegisterBirthPlace] = useState("");
  const [registerBirthDate, setRegisterBirthDate] = useState("");
  const [registerGender, setRegisterGender] = useState<CrewAccessGender>(
    CREW_ACCESS_GENDERS[0],
  );
  const [registerDomicile, setRegisterDomicile] = useState("");
  const [registerDegrees, setRegisterDegrees] = useState<CrewProfileDegree[]>(
    [],
  );
  const [registerJobTitles, setRegisterJobTitles] = useState<
    CrewProfilePosition[]
  >([]);
  ...
  const [registerServiceAreas, setRegisterServiceAreas] = useState<
  ...
  function resetRegisterForm() {
    ...
    setRegisterInstitution(
      institutionList[0] ?? CREW_ACCESS_INSTITUTIONS_SEED[0],
    );
  ...
  function validateRegisterStep(step: 1 | 2 | 3): string | null {
    if (step === 1) {
      ...
      if (registerPasswordInput.length < 15)
        return "Password minimal 15 karakter.";
      return null;
    }
    ...
    if (step === 2) {
      ...
      if (registerBirthPlace.trim().length < 2)
      ...
      if (registerJobTitles.length === 0)
        return "Pilih minimal satu jabatan atau posisi.";
      return null;
    }
    ...
    if (
      ...
      registerServiceAreaOther.trim().length < 3
    ) {
  ...
  useEffect(() => {
    ...
    fetch("/api/institutions")
      .then((r) =>
        r.ok ? (r.json() as Promise<{ institutions?: string[] }>) : null,
      )
      .then((d) => {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok || !payload?.ok) {
        setErrorMessage(
          payload?.error || "Username/email atau password tidak valid.",
        );
        return;
      }
  ...
  async function handleRegister(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok || !payload?.ok) {
        setRegisterErrorMessage(
          payload?.error || "Pendaftaran tidak dapat diproses.",
        );
        return;
      }
            ...
            <>
                ...
                <>
                  ...
                  <label style={{ display: "grid", gap: 6 }}>
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setRegisterInstitution(
                          event.target.value as CrewAccessInstitution,
                        )
                      }
                      style={inputStyle}
                    >
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setRegisterProfession(
                          event.target.value as CrewAccessProfession,
                        )
                      }
                      style={inputStyle}
                    >
                ...
                <>
                  ...
                  >
                    <label style={{ display: "grid", gap: 6 }}>
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          setRegisterBirthPlace(event.target.value)
                        }
                  ...
                  >
                    <label style={{ display: "grid", gap: 6 }}>
                      ...
                      <select
                        ...
                        onChange={(event) =>
                          setRegisterGender(
                            event.target.value as CrewAccessGender,
                          )
                        }
                        style={inputStyle}
                      >
                  ...
                  <label style={{ display: "grid", gap: 6 }}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setRegisterDomicile(event.target.value)
                      }
                  ...
                  <div style={{ display: "grid", gap: 8 }}>
                    ...
                    >
                      Pilih 1 sampai {CREW_PROFILE_MAX_POSITIONS}{" "}
                      jabatan/posisi.
                    </p>
                  </div>
                </>
                ...
                <>
                  ...
                  >
                    <label style={{ display: "grid", gap: 6 }}>
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          setRegisterEmployeeId(event.target.value)
                        }
                    ...
                    <label style={{ display: "grid", gap: 6 }}>
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          setRegisterStrNumber(event.target.value)
                        }
                        placeholder="opsional"
                        style={inputStyle}
                      />
                  ...
                  <label style={{ display: "grid", gap: 6 }}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setRegisterSipNumber(event.target.value)
                      }
                      placeholder="opsional"
                      style={inputStyle}
                    />
                  ...
                  {registerServiceAreas.includes("Lainnya") ? (
                    <label style={{ display: "grid", gap: 6 }}>
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          setRegisterServiceAreaOther(event.target.value)
                        }
              ...
              <div
                style={{
                  display: "flex",
                  justifyContent:
                    registerStep > 1 ? "space-between" : "flex-end",
                  gap: 12,
                }}
              >
                {registerStep > 1 ? (
