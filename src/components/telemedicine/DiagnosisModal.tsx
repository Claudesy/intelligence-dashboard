...
export function DiagnosisModal({
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `/api/telemedicine/appointments/${appointment.id}/diagnosis`,
        {
          method: "PATCH",
        ...
        >
          <FormField label="Anamnesis *" error={errors.anamnesis}>
            <textarea
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, anamnesis: e.target.value }))
              }
              style={textareaStyle}
            />
          </FormField>
          ...
          <FormField label="Pemeriksaan Fisik *" error={errors.pemeriksaan}>
            <textarea
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, pemeriksaan: e.target.value }))
              }
              style={textareaStyle}
            />
          </FormField>
          ...
          <FormField label="Tatalaksana *" error={errors.tatalaksana}>
            <textarea
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, tatalaksana: e.target.value }))
              }
              style={textareaStyle}
            />
          </FormField>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <input
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, rujukan: e.target.checked }))
              }
          ...
          {form.rujukan && (
            <FormField label="Tujuan Rujukan" error={errors.rujukanTujuan}>
              <input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, rujukanTujuan: e.target.value }))
                }
                style={inputStyle}
              />
            </FormField>
