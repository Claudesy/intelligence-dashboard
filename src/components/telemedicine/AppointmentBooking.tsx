...
const L = {
  ...
  actionNeumorph:
    "1px 1px 4px rgba(0,0,0,0.14), inset 1px 1px 0 rgba(255,255,255,0.03)",
  mono: "var(--font-mono)",
  sans: "var(--font-sans)",
};
...
export function AppointmentBooking({
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    fetch(
      `/api/telemedicine/slots?doctorId=${form.doctorId}&date=${selectedDate}`,
    )
      .then((r) => r.json())
    ...
    <div style={{}}>
        ...
        {STEPS.map((label, i) => {
          ...
          return (
            <div key={num} style={{ display: "flex", alignItems: "center" }}>
              ...
              {i < 2 && (
                <span
                  style={{ color: L.border, margin: "0 10px", fontSize: 13 }}
                >
                  ›
                </span>
              )}
      ...
      >
                ...
                {CONSULTATION_TYPES.map((opt) => {
                  ...
                  return (
                    <button
                      key={opt.value}
                      onClick={() =>
                        setForm((p) => ({ ...p, consultationType: opt.value }))
                      }
                      style={{
                        flex: 1,
                        display: "flex",
                  ...
                  {slots.map((slot) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() =>
                          setForm((p) => ({ ...p, scheduledAt: slotIso }))
                        }
                        style={{
                          display: "flex",
                          alignItems: "center",
          ...
          <>
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, keluhanUtama: e.target.value }))
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, bpjsNomorSEP: e.target.value }))
                }
                style={inputStyle}
              />
            </div>
        ...
        >
          <button
            onClick={
              step === 1 ? onCancel : () => setStep((s) => (s - 1) as 1 | 2)
            }
            style={{
              fontSize: 13,
              color: L.muted,
          ...
          {step < 3 ? (
            <button
              ...
              style={{
                ...
                borderRadius: 2,
                color: (step === 1 ? !canNext1 : !canNext2)
                  ? L.muted
                  : L.accent,
                fontSize: 13,
