...
async function main() {
  ...
  console.log(
    `Total: ${TOP_GEJALA.length} gejala | Perlu diproses: ${toProcess.length}`,
  );
  console.log("");
  ...
  console.log("");
  console.log(
    `✅ Selesai: ${total} gejala tersimpan di public/data/clinical-chains.json`,
  );
  console.log(
    `   Ukuran: ${Math.round(JSON.stringify(results).length / 1024)}KB`,
  );
}
